...
class NACA4Airfoil:
    def __init__(self, code: str, n_points: int = 200, chord: float = 1.0):
        ...
        self.cl_dict = self.create_dict()        

        self.cl_slopes_dict = self.create_dict()
        self.cl_offsets_dict = self.create_dict()

        self.dCp_dict = self.create_dict()
        self.xc_dict = self.create_dict()

        self.xp_dict = self.create_dict()
        self.Cp_dict = self.create_dict()
